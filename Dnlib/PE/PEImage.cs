...
namespace dnlib.PE {
	...
	public sealed class PEImage : IPEImage {
        ...
        //  get { return ((peInfo.ImageNTHeaders.OptionalHeader.DataDirectories.Length >= 14 && peInfo.ImageNTHeaders.OptionalHeader.DataDirectories.Get(14,null).Size > 0) == true ? true : false); }
        //}
